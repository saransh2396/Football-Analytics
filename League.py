...
os.chdir(r"D:\Personal\Football Analysis\Event Data\Team Analysis\Arsenal")

try:
    os.mkdir("Arsenal_stats")
except OSError:
    print("Folder Results Already Exists")
    
os.chdir(r"D:\Personal\Football Analysis\Event Data\Team Analysis\Arsenal\Arsenal_stats")
